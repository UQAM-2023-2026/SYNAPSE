...
// ===== POGOPIN 3 (UART3) PIN DEFINITIONS =====
#define POGOPIN3_RX_PIN 14     // GPIO14 (blue wire)
#define POGOPIN3_TX_PIN 12     // GPIO12 (green wire)
#define POGOPIN3_FLAG_PIN 26   // GPIO26 (connection detection flag)
