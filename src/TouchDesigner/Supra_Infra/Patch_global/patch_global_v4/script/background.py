...
def onValueChange(channel, sampleIndex, val, prev):
    if val == 1 and prev == 0:
        ...
        if channel.name == 'k0' or channel.name == 'idle':
            ...
            targets.par.value3  = 0.6
            targets.par.value4  = 0.6
            targets.par.value5  = 0.5
            targets.par.value6  = 0.02
            targets.par.value7  = 0.6
            targets.par.value8  = 0.3
            targets.par.value9  = 0.6
            targets.par.value10 = 0.4
